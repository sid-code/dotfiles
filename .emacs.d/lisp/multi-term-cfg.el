...
(global-set-key (kbd "s-z") nil)             ;make s-z a prefix key so we can get all tmux-y
(global-set-key (kbd "s-z c") 'multi-term)   ;start a term from anywhere
(global-set-key (kbd "s-z l")
                (lambda ()     ;like tmux, except any buffer
                  (interactive)
                  (switch-to-buffer (other-buffer (current-buffer) 1))))

;; bind s-z 1 through C-z 9 to select multi-term buffers by number from anywhere
(global-set-key (kbd "s-z 1") (lambda () (interactive) (switch-to-buffer "*terminal<1>*")))
(global-set-key (kbd "s-z 2") (lambda () (interactive) (switch-to-buffer "*terminal<2>*")))
(global-set-key (kbd "s-z 3") (lambda () (interactive) (switch-to-buffer "*terminal<3>*")))
(global-set-key (kbd "s-z 4") (lambda () (interactive) (switch-to-buffer "*terminal<4>*")))
(global-set-key (kbd "s-z 5") (lambda () (interactive) (switch-to-buffer "*terminal<5>*")))
(global-set-key (kbd "s-z 6") (lambda () (interactive) (switch-to-buffer "*terminal<6>*")))
(global-set-key (kbd "s-z 7") (lambda () (interactive) (switch-to-buffer "*terminal<7>*")))
(global-set-key (kbd "s-z 8") (lambda () (interactive) (switch-to-buffer "*terminal<8>*")))
(global-set-key (kbd "s-z 9") (lambda () (interactive) (switch-to-buffer "*terminal<9>*")))
...
(add-hook 'term-mode-hook
          (lambda ()
            ...
            (add-to-list 'term-bind-key-alist '("s-z p" . multi-term-prev))
            (add-to-list 'term-bind-key-alist '("s-z n" . multi-term-next))
            (add-to-list 'term-bind-key-alist '("s-z e" . term-send-esc))
            (add-to-list 'term-bind-key-alist '("s-z z" . term-send-ctrl-z))
            (add-to-list 'term-bind-key-alist '("s-z m" . term-toggle-line-char-mode))
            (add-to-list 'term-bind-key-alist '("s-z [" . term-toggle-line-char-mode)) ;char-mode
            (define-key term-mode-map (kbd "M-SPC") 'ric/term-toggle-line-char-mode)
            (define-key term-mode-map (kbd "s-z [")      'term-toggle-line-char-mode)  ;line-mode
            (define-key term-mode-map (kbd "<return>")      'ric/term-toggle-line-char-mode)  ;line-mode
            (add-to-list 'term-bind-key-alist '("s-z C-z" . term-toggle-line-char-mode))
...
(global-set-key (kbd "s-z [") 'term-toggle-line-char-mode)
;; (global-set-key (kbd "s-z C-z") 'term-toggle-line-char-mode)
;; (add-to-list 'term-bind-key-alist '("s-z [" . term-toggle-line-char-mode))
